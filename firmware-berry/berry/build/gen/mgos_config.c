...
static const struct mgos_conf_entry mgos_config_schema_[] = {
    {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 203},
    ...
    {.type = CONF_TYPE_OBJECT, .key = "gps", .offset = offsetof(struct mgos_config, gps), .num_desc = 3},
    {.type = CONF_TYPE_INT, .key = "uart_no", .offset = offsetof(struct mgos_config, gps.uart_no)},
    {.type = CONF_TYPE_INT, .key = "baud_rate", .offset = offsetof(struct mgos_config, gps.baud_rate)},
    {.type = CONF_TYPE_INT, .key = "update_interval", .offset = offsetof(struct mgos_config, gps.update_interval)},
...
const struct mgos_conf_entry *mgos_config_board_led1_get_schema(void) {
  return &mgos_config_schema_[186];
}
...
const struct mgos_conf_entry *mgos_config_board_led3_get_schema(void) {
  return &mgos_config_schema_[192];
}
...
const struct mgos_conf_entry *mgos_config_board_btn2_get_schema(void) {
  return &mgos_config_schema_[198];
}
...
const struct mgos_conf_entry *mgos_config_board_btn3_get_schema(void) {
  return &mgos_config_schema_[201];
}
...
void mgos_config_set_defaults(struct mgos_config *cfg) {
  ...
  mgos_config_gps_set_defaults(&cfg->gps);
...
const char * mgos_config_get_default_sntp_server(void) { return "it.pool.ntp.org"; }
...
/* gps */
const struct mgos_config_gps *mgos_config_get_gps(const struct mgos_config *cfg) { return &cfg->gps; }

/* gps.uart_no */
int mgos_config_get_gps_uart_no(const struct mgos_config *cfg) { return cfg->gps.uart_no; }
int mgos_config_get_default_gps_uart_no(void) { return 2; }
void mgos_config_set_gps_uart_no(struct mgos_config *cfg, int v) { cfg->gps.uart_no = v; }

/* gps.baud_rate */
int mgos_config_get_gps_baud_rate(const struct mgos_config *cfg) { return cfg->gps.baud_rate; }
int mgos_config_get_default_gps_baud_rate(void) { return 9600; }
void mgos_config_set_gps_baud_rate(struct mgos_config *cfg, int v) { cfg->gps.baud_rate = v; }

/* gps.update_interval */
int mgos_config_get_gps_update_interval(const struct mgos_config *cfg) { return cfg->gps.update_interval; }
int mgos_config_get_default_gps_update_interval(void) { return 2000; }
void mgos_config_set_gps_update_interval(struct mgos_config *cfg, int v) { cfg->gps.update_interval = v; }
